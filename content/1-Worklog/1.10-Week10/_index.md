...
* Complete the event-participation record and its supporting evidence.
* Clearly present the attendee role and the knowledge gained from each event.
...
* Completed bilingual reports for both events, including photo evidence.
* Correctly recorded the attendee role for both events and added 11 July 2026 as the Event 1 date.
* Standardized images and links so that the Events section displays reliably on the report website.
